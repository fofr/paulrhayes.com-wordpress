<!DOCTYPE html>
<!--[if IE 8 ]><html lang="en" id="paulrhayes-com"  class="noJs ie ie8"><![endif]-->
<!--[if IE 9 ]><html lang="en" id="paulrhayes-com"  class="noJs ie ie9"><![endif]-->
<!--[if (gt IE 9)|!(IE)]><!--><html lang="en" id="paulrhayes-com" class="noJs"><!--<![endif]-->
<head>
	...
	<link rel="stylesheet" href="/css/master.css?6" />
	<?php wp_head(); ?>
